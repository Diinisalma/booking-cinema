...
CREATE TABLE public.t_movie (
	...
	landscape_image_url varchar(255) NULL,
...
CREATE TABLE public.t_movie_studio_schedule (
	...
	CONSTRAINT t_movie_studio_schedule_pkey PRIMARY KEY (id),
	CONSTRAINT fkdd74384lpcpgfh89sde10wxb2 FOREIGN KEY (movie_id) REFERENCES public.t_movie(id),
	CONSTRAINT fksubaw5h02tgoq06v6108caltc FOREIGN KEY (studio_id) REFERENCES public.t_studio(id)
);
...
CREATE TABLE public.t_booking (
	...
	cancel_timestamp timestamp(6) NULL,
	order_timestamp timestamp(6) NOT NULL,
	payment_timestamp timestamp(6) NULL,
	status varchar(255) NOT NULL,
	schedule_id int8 NOT NULL,
	user_id int8 NOT NULL,
	CONSTRAINT t_booking_pkey PRIMARY KEY (id),
	CONSTRAINT t_booking_status_check CHECK (((status)::text = ANY ((ARRAY['BOOKED'::character varying, 'COMPLETED'::character varying, 'CANCELLED'::character varying, 'EXPIRED'::character varying])::text[]))),
	CONSTRAINT fkayifinbua5a16p2dbou47l0dk FOREIGN KEY (user_id) REFERENCES public.t_user(id),
	CONSTRAINT fknki6m8dw2di0h1lbs41pfwrxt FOREIGN KEY (schedule_id) REFERENCES public.t_movie_studio_schedule(id)
);
